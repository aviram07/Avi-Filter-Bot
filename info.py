...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002620727954').split()]
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002281894894').split()]
MAX_B_TN = environ.get("MAX_B_TN", "7")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_request04')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Newmovie5478')
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002281894894)) # movies request channel, else log channel
